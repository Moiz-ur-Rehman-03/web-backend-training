...
*/
type newObject<K extends string,T,V> = T & {[keys in K]: V};

export class ObjectManipulator<T> {

    constructor(protected obj:T) {}

    public set<K extends string,V>(key:K, value:V):ObjectManipulator<newObject<K,T,V>> {
        return new ObjectManipulator({...this.obj, [key]: value} as newObject<K,T,V>)
    }
